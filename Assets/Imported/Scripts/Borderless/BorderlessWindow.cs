...
public class BorderlessWindow
{
    ...
    public static void CenterWindow()
    {
        ...
        Debug.Log($"WindowHeight = {windowHeight} <=> Screen.currentResolution.height {Screen.currentResolution.height}");
        if (windowHeight != Screen.currentResolution.height)
        {
            y = Display.main.renderingHeight / 2;
        }
        Debug.Log($"WindowHeight = {windowHeight} <=> Screen.currentResolution.width {Screen.currentResolution.width}");
